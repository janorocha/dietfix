...
import { ReactAgenda, ReactAgendaCtrl, guid, getUnique, getLast, getFirst, Modal } from './react-agenda/index.js';
import Main from '../template/Main'

const headerProps = {
  icon: 'calendar',
  title: 'Agenda',
  subtitle: 'Agenda de consultas e retornos de pacientes'
}
